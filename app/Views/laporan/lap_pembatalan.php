    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Laporan Pembatalan Berdasarkan Maskapai</h3>
        </div>
        <div class="card-body">
            <form action="<?=base_url ()?>/laporan/cetak_pembatalan" method="post">
          <div class="row">
            <div class="col-md-10">
...
<div style="float: left; width: 49%; padding: 10px;">
<div class="container-fluid">
<form action="<?=base_url ()?>/laporan/cetak_pembatalan_periode" method="post">
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Laporan Pembatalan Berdasarkan Periode</h3>
        </div>
        <div class="card-body">
